...
static char *font = "DejaVuSansMono Nerd Font:style=Book:pixelsize=15:antialias=true:autohint=true";
// static char *font = "Hack:style=Book:pixelsize=15:antialias=true:autohint=true";
